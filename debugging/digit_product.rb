...
# the method here is returns the last line
# which is product but the problem is that product
# was set to 0. product needs to be changed to 1 in order
# increment and multiply appropriately