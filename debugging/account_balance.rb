...
[january, february, march].each do |month|
  balance = balance + calculate_balance(month) # += here
end

puts balance
# balance = needs to be reassigned to balance = balance + calculate_balance(month)
# in order to get the running total instead of just eath month
