...
#false if they aren't. Then, perform the same case-insensitive comparison, except 
#compare the value of name with the string 'DAVE' instead of 'RoGeR'.
...
puts name.downcase == ('David').downcase ? 'true' : 'false'